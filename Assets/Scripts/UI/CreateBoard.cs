...
public class CreateBoard : MonoBehaviour
{
    ...
    void Update()
    {
        if (openAI.response != "" && sended)
        {
            MapSpliter.IncomingMessage(openAI.response);
            sended = false;
        }
